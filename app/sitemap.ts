...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const mainRoutes = [
    ...
    { route: '/divination', changeFrequency: 'weekly', priority: 0.95 },
    { route: '/bazi', changeFrequency: 'weekly', priority: 0.9 },
    { route: '/i-ching', changeFrequency: 'weekly', priority: 0.9 },
    { route: '/name-analysis', changeFrequency: 'weekly', priority: 0.85 },
    { route: '/name-generator', changeFrequency: 'weekly', priority: 0.85 },
    { route: '/love-match', changeFrequency: 'weekly', priority: 0.85 },
